...
Most of these come down to network reality or how pythondiscuss serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pythondiscuss rate-limits like any public site. pd already paces
...
Where a surface is gated, pd reads a cookie or token you supply
...
`pd`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pd actually did
